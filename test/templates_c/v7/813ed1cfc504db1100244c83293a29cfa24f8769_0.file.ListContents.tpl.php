...
function content_6602a8e145a671_44549792 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
} else { ?><li><a	<?php if (stripos($_smarty_tpl->tpl_vars['SETTINGS_LINK']->value['linkurl'],'javascript:') === 0) {?>onclick='<?php echo substr((string) $_smarty_tpl->tpl_vars['SETTINGS_LINK']->value['linkurl'], (int) strlen((string) "javascript:"));?>
