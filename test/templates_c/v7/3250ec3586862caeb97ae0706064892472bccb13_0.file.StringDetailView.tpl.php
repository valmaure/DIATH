...
function content_6602a8a5cfbca1_31854690 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php } elseif ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType() == 'multipicklist' && $_smarty_tpl->tpl_vars['MODULE']->value != 'Users') {?>
    ...
    <?php $_smarty_tpl->_assignInScope('MULTI_RAW_PICKLIST_VALUES', smarty_modifier_explode('|##|',$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('fieldvalue')));?>
    <?php $_smarty_tpl->_assignInScope('MULTI_PICKLIST_VALUES', smarty_modifier_explode(',',$_smarty_tpl->tpl_vars['PICKLIST_DISPLAY_VALUE']->value));?>
    <?php
